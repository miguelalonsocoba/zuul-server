...
/**
 * Se crea la configuración del servidor de recursos. Se encarga de proteger y
 * dar acceso a los microservicios.
 */
@RefreshScope
@Configuration
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	/**
	 * Realiza la configuración de los cors.
	 * 
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		corsConfig.setAllowedHeaders(Arrays.asList("POST", "GET", "PUT", "DELETE", "OPTIONS"));
